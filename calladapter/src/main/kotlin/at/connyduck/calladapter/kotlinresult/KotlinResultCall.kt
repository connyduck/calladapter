...
internal class KotlinResultCall<S : Any>(
        ...
        return delegate.enqueue(
            object : Callback<S> {
                ...
                override fun onFailure(call: Call<S>, throwable: Throwable) {
                    val networkResponse = Result.failure<S>(throwable)

                    callback.onResponse(this@KotlinResultCall, Response.success(networkResponse))
                }
            }
        )
    }
    ...
    override fun clone() = KotlinResultCall(delegate.clone())
