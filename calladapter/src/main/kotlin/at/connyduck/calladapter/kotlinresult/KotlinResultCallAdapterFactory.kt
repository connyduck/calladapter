...
public class KotlinResultCallAdapterFactory internal constructor() : CallAdapter.Factory() {
    ...
    override fun get(
        ...
        return KotlinResultCallAdapter<Any>(successBodyType)
    }

    public companion object {
        @JvmStatic
        public fun create(): KotlinResultCallAdapterFactory = KotlinResultCallAdapterFactory()
    }
}
